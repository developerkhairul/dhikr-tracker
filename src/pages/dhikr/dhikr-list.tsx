...
import { Search, Filter, Plus, RotateCcw, MoreVertical } from 'lucide-react';
...
const DhikrList = () => {
  const [dhikrs, setDhikrs] = React.useState<Dhikr[]>([
  ...
  const progress = (d: Dhikr) => d.goal ? Math.min(100, Math.round((d.count / d.goal) * 100)) : 0;
